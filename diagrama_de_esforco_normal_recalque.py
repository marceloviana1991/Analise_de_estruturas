def diag_nor(restricoes_de_apoio, rotula, caracteristicas, comprimento, angulo, deslocabilidades, i, j, recalque,
    ...
    for a in range(len(comprimento)):
        ...
        caso_0.append(vetor_dos_termos_de_carga_local[0][0])
        caso_0.append(vetor_dos_termos_de_carga_local[3][0])

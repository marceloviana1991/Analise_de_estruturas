def diag_mom(comprimento, angulo, rotula, caracteristicas, restricoes_de_apoio, deslocabilidades, i, j,
             recalque, vetor_dos_termos_de_carga):
    import math
    ...
    for a in range(len(recalque) * 3):
        aux.append(0)
    for a in range(len(rotula) * 2):
    ...
    for a in range(len(comprimento)):
        ...
        caso_0.append(vetor_dos_termos_de_carga_local[2][0])
        caso_0.append(vetor_dos_termos_de_carga_local[5][0])
